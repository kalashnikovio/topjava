...
public class MealsUtil {
    ...
    public static final int DEFAULT_CALORIES_MAXIMUM = 2000;

    public static void main(String[] args) {
        List<MealTo> mealsTo = filteredByStreams(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), DEFAULT_CALORIES_MAXIMUM);
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealTo> getMealTos(List<Meal> meals, int caloriesMaximum) {
        return filteredByStreams(meals, LocalTime.MIN, LocalTime.MAX, caloriesMaximum);
    }
}
